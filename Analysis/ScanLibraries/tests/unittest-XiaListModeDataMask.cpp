...
SetFirmware(*it);
for (
vector<unsigned>::iterator it1 = freq.begin();
it1 != freq.
...
vector<unsigned int> freq = {100, 250, 500};
for (
vector<unsigned>::iterator it = freq.begin();
it != freq.
